    ...
    <div className="relative">
      ...
      {isOpen && (
        <PortalPanel
          ...
          className={
            isFuwari
              ? "fuwari-card-base p-1.5 shadow-lg animate-in fade-in-0 zoom-in-95 max-h-[60vh] overflow-y-auto custom-scrollbar"
              : "border border-border/30 bg-background shadow-md max-h-[60vh] overflow-y-auto custom-scrollbar"
          }
        >
          {providers.map((p) => {
